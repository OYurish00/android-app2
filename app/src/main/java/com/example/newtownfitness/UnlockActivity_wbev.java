...
public class UnlockActivity_wbev extends AppCompatActivity {

    Button unlock_btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_unlock_wbev);

        unlock_btn = findViewById(R.id.unlock_btn);
        LoadingDialog loadingDialog = new LoadingDialog(UnlockActivity_wbev.this);
