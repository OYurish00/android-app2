...
public class UnlockActivity_west extends AppCompatActivity {

    Button unlock_btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_unlock_west);

        unlock_btn = findViewById(R.id.unlock_btn);
        LoadingDialog loadingDialog = new LoadingDialog(UnlockActivity_west.this);
    ...
    private void launchActivityWBev() {
        Intent intentwest = new Intent(this, UnlockActivity_wbev.class);
