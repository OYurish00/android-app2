...
public class UnlockActivity_fourth extends AppCompatActivity {

    Button unlock_btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_unlock_fourth);

        unlock_btn = findViewById(R.id.unlock_btn);
        LoadingDialog loadingDialog = new LoadingDialog(UnlockActivity_fourth.this);
    ...
    private void launchActivityWBev() {
        Intent intentfour = new Intent(this, UnlockActivity_wbev.class);
