...
public class UnlockActivity_south extends AppCompatActivity {

    Button unlock_btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_unlock_south);

        unlock_btn = findViewById(R.id.unlock_btn);
        LoadingDialog loadingDialog = new LoadingDialog(UnlockActivity_south.this);
    ...
    private void launchActivityWBev() {
        Intent intentsou = new Intent(this, UnlockActivity_wbev.class);
