...
public class UnlockActivity_east extends AppCompatActivity {

    Button unlock_btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_unlock_east);

        unlock_btn = findViewById(R.id.unlock_btn);
        LoadingDialog loadingDialog = new LoadingDialog(UnlockActivity_east.this);
    ...
    private void launchActivityWBev() {
        Intent intenteast = new Intent(this, UnlockActivity_wbev.class);
